...
for yr in YEARS:
    ...
    rows.append({
        ...
        "Regulatory_Cost_USD": reg_cost_opt,
        "Premium_Fuel_Cost_USD": PREMIUM * oth_inc_t,
        "Total_Optimized_Cost_USD": reg_cost_opt + (PREMIUM * oth_inc_t),
    })
...
with c4:
    bar_chart("Total Optimized Cost [USD]", "Total_Optimized_Cost_USD")
